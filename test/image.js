...
tester.run(
	...
	},
	{
      ...
      Some more text here`,
		...
		invalid: [
			{
				text: '![Dxplosion](https://media.giphy.com/media/XUFPGrX5Zis6Y/giphy.gif "nuclear Explosion")',
				output:
					'![explosion](https://media.giphy.com/media/XUFPGrX5Zis6Y/giphy.gif "nuclear Explosion")',
				errors: [
					{
...
tester.run(
	...
	},
	{
		...
		invalid: [
			{
				text: '![Explosion of npmm](https://media.giphy.com/media/XUFPGrX5Zis6Y/giphy.gif "nuclear Explosion")',
				errors: [
					{
						message:
